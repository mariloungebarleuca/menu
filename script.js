const menuData = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Absolute Vodka Tonic/Lemon/Red Bull", name_en: "Absolut Vodka Tonic/Lemon/Red Bull", price: 7.00, description: "Absolut vodka con tonica, lemon o Red Bull.", description_en: "Absolut vodka with tonic, lemon or Red Bull." },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Fondente", name_en: "Dark Chocolate", price: 4.50, description: "Crepe con cioccolato fondente.", description_en: "Crepe with dark chocolate.", allergens: ["Glutine", "Latte", "Uova"], allergens_en: ["Gluten", "Milk", "Eggs"] },
            { name: "Oreo", name_en: "Oreo", price: 4.50, description: "Crepe con crema e biscotto Oreo.", description_en: "Crepe with cream and Oreo cookie.", allergens: ["Glutine", "Latte", "Uova", "Soia"], allergens_en: ["Gluten", "Milk", "Eggs", "Soy"] },
            { name: "Lotus", name_en: "Lotus", price: 4.50, description: "Crepe con crema Lotus.", description_en: "Crepe with Lotus cream.", allergens: ["Glutine", "Latte", "Uova", "Soia"], allergens_en: ["Gluten", "Milk", "Eggs", "Soy"] },
            ...
            { name: "Bigusto", name_en: "Two Flavours", price: 4.00, description: "Crepe con due gusti a scelta.", description_en: "Crepe with two flavours of choice.", allergens: ["Glutine", "Latte", "Uova"], allergens_en: ["Gluten", "Milk", "Eggs"] }
        ]
    },
    {
        ...
        items: [
            ...
            { name: "Choco Crispy", name_en: "Choco Crispy", price: 6.50, description: "Cioccolato crispy.", description_en: "Crispy chocolate.", allergens: ["Glutine", "Latte", "Uova"], allergens_en: ["Gluten", "Milk", "Eggs"] },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Salame", name_en: "Salami", price: 6.00, description: "Crepe con salame, formaggio (svizzero o scamorza o formaggio filato o Philadephia), rucola e salse.", description_en: "Crepe with salami, cheese (Swiss or scamorza or  Philadelphia), arugula and sauces.", allergens: ["Glutine", "Latte", "Uova"], allergens_en: ["Gluten", "Milk", "Eggs"] },
            { name: "Salmone", name_en: "Salmon", price: 7.00, description: "Crepe con salmone e Philadelphia e rucola.", description_en: "Crepe with salmon, cream cheese and Arugola.", allergens: ["Glutine", "Latte", "Uova", "Pesce"], allergens_en: ["Gluten", "Milk", "Eggs", "Fish"] }
        ]
    },
    {
        category: "Frise",
