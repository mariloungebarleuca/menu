const menuData = [
...

    {
        ...
        icon: "🥤",
        items: [
            { name: "Acqua Naturale", name_en: "Still Water", price: 1.50 },
            { name: "Acqua Frizzante", name_en: "Sparkling Water", price: 1.50 },
    ...
    },
    {
        ...
        icon: "🧃",
        items: [
            { name: "Succo Pera", name_en: "Pear Juice", price: 3.00 },
            { name: "Succo Pesca", name_en: "Peach Juice", price: 3.00 },
            { name: "Succo Ananas", name_en: "Pineapple Juice", price: 3.00 },
            { name: "Succo Albicocca", name_en: "Apricot Juice", price: 3.00 },
            { name: "Succo Melograna", name_en: "Pomegranate Juice", price: 3.00 },
    ...
    },
    {
        ...
        icon: "🍺",
        items: [
            { name: "Peroni Nastro Azzurro", name_en: "Peroni Nastro Azzurro", price: 3.50, allergens: ["Glutine"], allergens_en: ["Gluten"] },
            ...
            { name: "Peroni 0.0", name_en: "Peroni 0.0", price: 3.50, allergens: ["Glutine"], allergens_en: ["Gluten"] },
    ...
    },
    {
        ...
        icon: "🥂",
        items: [
            { name: "Prosecco Palladio (calice)", name_en: "Prosecco Palladio (glass)", price: 4.50, allergens: ["Solfiti"], allergens_en: ["Sulphites"] },
            ...
            { name: "Moët & Chandon Imperial", name_en: "Moët & Chandon Imperial", price: 80.00, allergens: ["Solfiti"], allergens_en: ["Sulphites"] },
            { name: "Moët & Chandon Ice Imperial", name_en: "Moët & Chandon Ice Imperial", price: 105.00, allergens: ["Solfiti"], allergens_en: ["Sulphites"] }
        ]
    },
    {
    ...
    },
    {
        ...
        icon: "🍹",
        items: [
            { name: "Aperol Spritz", name_en: "Aperol Spritz", price: 6.00, description: "Aperol, prosecco, soda.", description_en: "Aperol, prosecco, soda water.", allergens: ["Solfiti"], allergens_en: ["Sulphites"] },
            ...
            { name: "Campari Gin", name_en: "Campari Gin", price: 8.00, description: "Campari e gin.", description_en: "Campari and gin." },
            ...
            { name: "Vodka Tonic/Lemon/Red Bull", name_en: "Vodka Tonic/Lemon/Red Bull", price: 7.00, description: "Vodka con tonica, lemon o Red Bull.", description_en: "Vodka with tonic, lemon or Red Bull." },
            { name: "Absolute Vodka Tonic/Lemon/Red Bull", name_en: "Absolute Vodka Tonic/Lemon/Red Bull", price: 8.00, description: "Vodka Absolute con tonica, lemon o Red Bull.", description_en: "Absolute vodka with tonic, lemon or Red Bull." },
            ...
            { name: "Gin Tonic/Lemon", name_en: "Gin Tonic/Lemon", price: 7.00, description: "Gin, tonica o lemon soda, ghiaccio.", description_en: "Gin, tonic or lemon soda, ice." },
            { name: "Malfy Pompelmo Tonic/Lemon", name_en: "Malfy Grapefruit Tonic/Lemon", price: 8.00, description: "Malfy gin al pompelmo, tonica o lemon soda, ghiaccio.", description_en: "Malfy grapefruit gin, tonic or lemon soda, ice." },
            { name: "Malfy Tonic/Lemon", name_en: "Malfy Tonic/Lemon", price: 8.00, description: "Malfy gin, tonica o lemon soda, ghiaccio.", description_en: "Malfy gin, tonic or lemon soda, ice." },
            { name: "Hendrix Tonic/Lemon", name_en: "Hendrix Tonic/Lemon", price: 9.00, description: "Hendrix gin, tonica o lemon soda, ghiaccio.", description_en: "Hendrix gin, tonic or lemon soda, ice." },
            { name: "J.Rose Tonic/Lemon", name_en: "J.Rose Tonic/Lemon", price: 9.00, description: "J.Rose gin, tonica o lemon soda, ghiaccio.", description_en: "J.Rose gin, tonic or lemon soda, ice." },
            { name: "Mare Tonic/Lemon", name_en: "Mare Tonic/Lemon", price: 9.00, description: "Gin Mare, tonica o lemon soda, ghiaccio.", description_en: "Mare gin, tonic or lemon soda, ice." },
            { name: "Bulldog Tonic/Lemon", name_en: "Bulldog Tonic/Lemon", price: 9.00, description: "Bulldog gin, tonica o lemon soda, ghiaccio.", description_en: "Bulldog gin, tonic or lemon soda, ice." },
            { name: "Roku Tonic/Lemon", name_en: "Roku Tonic/Lemon", price: 9.00, description: "Roku gin, tonica o lemon soda, ghiaccio.", description_en: "Roku gin, tonic or lemon soda, ice." },            
            ...
            { name: "Rum e Cola", name_en: "Rum and Coke", price: 7.00, description: "Rum, cola, lime.", description_en: "Rum, cola, lime." },
            { name: "Havana Rum e Cola", name_en: "Havana Rum and Coke", price: 8.00, description: "Havana rum, cola, lime.", description_en: "Havana rum, cola, lime." },
            { name: "Malibù e Cola", name_en: "Malibu and Coke", price: 7.00, description: "Malibù, cola, ghiaccio.", description_en: "Malibu, cola, ice." },
            { name: "Malibù e Ananas", name_en: "Malibu and Pineapple", price: 7.00, description: "Malibù, succo di ananas, ghiaccio.", description_en: "Malibu, pineapple juice, ice." },
            { name: "Jager Bomb", name_en: "Jager Bomb", price: 7.00, description: "Jagermeister e Red Bull.", description_en: "Jagermeister and Red Bull." },
            { name: "Negroni / Negroni Sbagliato", name_en: "Negroni / Negroni Sbagliato", price: 8.00, description: "Gin o prosecco, vermouth, Campari.", description_en: "Gin or prosecco, vermouth, Campari.", allergens: ["Solfiti"], allergens_en: ["Sulphites"] },
            { name: "Sex on the Beach", name_en: "Sex on the Beach", price: 7.00, description: "Vodka, pesca, ananas, mirtillo.", description_en: "Vodka, peach, pineapple, cranberry." },
            { name: "Japanese", name_en: "Japanese", price: 8.00, description: "Cognac, mandorla, limone.", description_en: "Cognac, almond, lemon.", allergens: ["Frutta a guscio (mandorla)"], allergens_en: ["Tree nuts (almond)"] },
            { name: "Cosmopolitan", name_en: "Cosmopolitan", price: 8.00, description: "Vodka, Cointreau, mirtillo, lime.", description_en: "Vodka, Cointreau, cranberry, lime." },
    ...
    },
    {
        ...
        icon: "🥃",
        items: [
            { name: "Grappa POLI Bianca", name_en: "Grappa POLI Bianca", price: 4.50 },
            { name: "Grappa POLI Barricata", name_en: "Grappa POLI Barricata", price: 4.50 },
            { name: "Tequila ESPOLON Blanco", name_en: "Tequila ESPOLON Blanco", price: 4.50 },
            { name: "Tequila ESPOLON Reposado", name_en: "Tequila ESPOLON Reposado", price: 4.50 },
            { name: "Jack Daniel's", name_en: "Jack Daniel's", price: 4.50, allergens: ["Glutine"], allergens_en: ["Gluten"] },
            { name: "Lagavulin", name_en: "Lagavulin", price: 5.50, allergens: ["Glutine"], allergens_en: ["Gluten"] }
        ]
    },
    {
        category: "Vini",
        ...
        icon: "🍷",
        items: [
            { name: "Cantele Chardonnay IGP (calice)", name_en: "Cantele Chardonnay IGP (glass)", price: 4.50, allergens: ["Solfiti"], allergens_en: ["Sulphites"] },
    ...
    },
    {
        ...
        icon: "🥞",
        items: [
            { name: "Nutella", name_en: "Nutella", price: 4.50, description: "Crepe con Nutella.", description_en: "Crepe with Nutella.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio (nocciola)"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts (hazelnut)"] },
            { name: "Nutella Vegana", name_en: "Vegan Nutella", price: 4.50, description: "Crepe con Nutella vegana.", description_en: "Crepe with vegan Nutella.", allergens: ["Glutine", "Uova", "Frutta a guscio (nocciola)"], allergens_en: ["Gluten", "Eggs", "Tree nuts (hazelnut)"] },
            { name: "Nutella Bianca", name_en: "White Nutella", price: 5.00, description: "Crepe con crema bianca alla nocciola.", description_en: "Crepe with white hazelnut cream.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio (nocciola)"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts (hazelnut)"] },
            { name: "Fondente", name_en: "Dark Chocolate", price: 5.00, description: "Crepe con cioccolato fondente.", description_en: "Crepe with dark chocolate.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] },
            { name: "Oreo", name_en: "Oreo", price: 5.00, description: "Crepe con crema e biscotto Oreo.", description_en: "Crepe with cream and Oreo cookie.", allergens: ["Glutine", "Latte", "Uova", "Soia", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Soy", "Tree nuts"] },
            { name: "Lotus", name_en: "Lotus", price: 5.00, description: "Crepe con crema Lotus.", description_en: "Crepe with Lotus cream.", allergens: ["Glutine", "Latte", "Uova", "Soia", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Soy", "Tree nuts"] },
            { name: "Raffaello", name_en: "Raffaello", price: 5.00, description: "Crepe con crema Raffaello.", description_en: "Crepe with Raffaello cream.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio (cocco, mandorla)"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts (coconut, almond)"] },
            { name: "Pistacchio", name_en: "Pistachio", price: 5.50, description: "Crepe con crema al pistacchio.", description_en: "Crepe with pistachio cream.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio (pistacchio)"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts (pistachio)"] },
            { name: "Bigusto", name_en: "Two Flavours", price: 5.50, description: "Crepe con due gusti a scelta.", description_en: "Crepe with two flavours of choice.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] }
        ]
    },
    {
    ...
    },
    {
        ...
        icon: "🧀",
        items: [
            { name: "Crudo", name_en: "Cured Ham", price: 6.50, description: "Crepe con prosciutto crudo, formaggio (svizzero o scamorza o formaggio filato o Philadephia), rucola e salse.", description_en: "Crepe with cured ham, cheese (Swiss or scamorza or  Philadelphia), arugula and sauces.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] },
            { name: "Cotto", name_en: "Cooked Ham", price: 6.50, description: "Crepe con prosciutto cotto, formaggio (svizzero o scamorza o formaggio filato o Philadephia), rucola e salse.", description_en: "Crepe with cooked ham, cheese (Swiss or scamorza or  Philadelphia), arugula and sauces.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] },
            { name: "Salame", name_en: "Salami", price: 6.50, description: "Crepe con salame, formaggio (svizzero o scamorza o formaggio filato o Philadephia), rucola e salse.", description_en: "Crepe with salami, cheese (Swiss or scamorza or  Philadelphia), arugula and sauces.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] },
            { name: "Salmone", name_en: "Salmon", price: 8.00, description: "Crepe con salmone e Philadelphia e rucola.", description_en: "Crepe with salmon, cream cheese and Arugola.", allergens: ["Glutine", "Latte", "Uova", "Pesce"], allergens_en: ["Gluten", "Milk", "Eggs", "Fish", "Tree nuts"] }
        ]
    },
    {
        category: "Frise",
        ...
        icon: "🫓",
        items: [
            { name: "Pomodoro", name_en: "Tomato", price: 3.50, description: "Frisa con pomodoro fresco e olio.", description_en: "Frisa with fresh tomato and oil.", allergens: ["Glutine"], allergens_en: ["Gluten"] },
            { name: "Salamura", name_en: "Salamura", price: 8.00, description: "Frisa con peperonata salentina (leggermente piccante).", description_en: "Frisa with Salento peperonata (slightly spicy).", allergens: ["Glutine"], allergens_en: ["Gluten"] },
            { name: "Pezzetti di Cavallo", name_en: "Horse Stew", price: 9.00, description: "Frisa con pezzetti di cavallo. (powered by Macelleria Petracca)", description_en: "Frisa with horse stew. (powered by Macelleria Petracca)", allergens: ["Glutine"], allergens_en: ["Gluten"] },
            { name: "Coppa di Suino", name_en: "Pork Shoulder", price: 9.00, description: "Frisa con coppa di suino, stracciatella, pomodori secchi e melanzane sott'olio. (powered by Macelleria Petracca)", description_en: "Frisa with pork shoulder, stracciatella, sun-dried tomatoes and eggplant in oil. (powered by Macelleria Petracca)", allergens: ["Glutine", "Latte"], allergens_en: ["Gluten", "Milk"] },
            { name: "Alici", name_en: "Anchovies", price: 7.00, description: "Frisa con pomodoro fresco, capperi e alici.", description_en: "Frisa with fresh tomatoes, capers and anchovies.", allergens: ["Glutine", "Pesce"], allergens_en: ["Gluten", "Fish"] },
            { name: "Tartare di Tonno", name_en: "Tuna Tartare", price: 15.00, description: "Frisa con 80 gr di tartare di tonno rosso, gelée al cocomero, cocomero, cipolla agrodolce e zest di limone.", description_en: "Frisa with 80g of red tuna tartare, watermelon gelée, watermelon, sweet-and-sour onions and lemon zest.", allergens: ["Glutine", "Pesce"], allergens_en: ["Gluten", "Fish"] },
            { name: "Tartare di Gambero", name_en: "Prawn Tartare", price: 15.00, description: "Frisa con 80 gr di tartare di gambero viola, stracciatella, zest di lime e pepe rosa.", description_en: "Frisa with 80g of purple prawn tartare, stracciatella, lime zest and pink pepper.", allergens: ["Glutine", "Crostacei", "Latte"], allergens_en: ["Gluten", "Crustaceans", "Milk"] }
        ]
    },
    {
