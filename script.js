const menuData = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Pistacchio", name_en: "Pistachio", price: 5.00, description: "Crepe con crema al pistacchio.", description_en: "Crepe with pistachio cream.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio (pistacchio)"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts (pistachio)"] },
            { name: "Bigusto", name_en: "Two Flavours", price: 5.00, description: "Crepe con due gusti a scelta.", description_en: "Crepe with two flavours of choice.", allergens: ["Glutine", "Latte", "Uova", "Frutta a guscio"], allergens_en: ["Gluten", "Milk", "Eggs", "Tree nuts"] }
        ]
    },
    {
